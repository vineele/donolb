...
function PaletteIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
      ...
      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.477-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.555 0-1.762-.707-3.355-1.848-4.496" />
    </svg>
  )
}
              ...
              <div className="flex-1 overflow-y-auto px-5 py-5">
                ...
                {tab === 'css' && (
                  <div className="space-y-4">
                    ...
                    <p className="text-[11px] text-muted-foreground leading-relaxed">
                      Raw CSS injected into the page. Use any valid CSS — overrides Tailwind styles. Persists across refreshes.
                    </p>
                    <textarea
                      value={customCss}
...
aside {
  opacity: 0.9;
                      ...
                      className="h-72 w-full resize-y rounded-lg border border-white/10 bg-black/40 px-3 py-3 font-mono text-[11px] leading-relaxed text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary"
                    />
              ...
              {SHOW_EXPORT_LINK && (
                <div className="shrink-0 border-t border-white/6 px-5 py-4">
                  <button
                    ...
                    disabled={exporting}
                    className="flex w-full items-center justify-center gap-2 rounded-lg border border-primary/40 bg-primary/10 px-3 py-2.5 text-xs font-semibold text-primary transition-colors hover:bg-primary/20 disabled:opacity-50"
                  >
