...
export default function HomePage() {
  ...
  return (
    <div className="lb-home-page mx-auto flex max-w-6xl flex-col gap-8 px-4 py-8 md:px-8">
      <header className="lb-home-header flex flex-col gap-1">
      ...
      <div className="lb-home-metrics grid grid-cols-1 gap-3 sm:grid-cols-3">
      ...
      <div className="lb-home-content grid grid-cols-1 gap-8 lg:grid-cols-[1fr_340px]">
        <Leaderboard />

        <aside className="lb-home-feed flex flex-col gap-3" aria-label="Live activity">
